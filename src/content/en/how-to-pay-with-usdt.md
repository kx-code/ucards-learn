...
**Pros:** No intermediary, direct transfer
**Cons:** Limited merchant acceptance, you must have USDT in a wallet
...
**Pros:** Wider merchant network
**Cons:** Additional processing fees (typically 0.5-1.5%)
...
**Pros:** Works at every online merchant, no KYC required, instant setup
**Cons:** Limited to online transactions
...
- **Sending to the wrong network** — TRC20 USDT sent to an ERC20 address is permanently lost
- **Incorrect amount** — Always verify the exact amount, including any decimal places
- **Using an unsupported wallet** — Ensure your wallet supports the network you select
- **Forgetting memo/destination tag** — Some exchanges require a memo tag for USDT deposits

## USDT Payment Security Tips

- Always **double-check the recipient address** before confirming
- Use **TRC20 for small payments** to minimize fee overhead
- Verify the **merchant's payment page** is legitimate before sending
- Keep your **wallet software updated** for the latest security patches
- Use a **dedicated wallet** for payments rather than your main holdings wallet
